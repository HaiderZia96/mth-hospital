...
@section('content')
    ...
    @foreach($achievements_details as $award)
        ...
        <div class="achievement-details-area ptb-100">
            <div class="container">
                <div class="row justify-content-center">

                    <div class="col-lg-8">
                        <div class="achievement-details-content mb-5">
                            {{--                        <img src="{{asset('/front/coreui/assets/img/blog-1.jpg')}}" class="blog-post-img" alt="Image">--}}
                            <div class="achievement-post-img">
                                <img src="{{route('achievements.getImage',[$award->id,$award->image_url_name]) }}"
                                     alt="" class="main">
                            </div>
                            <span class="tag">{{$award->department_name}}</span>
                            <ul>
                                {{--                                <li>--}}
                                {{--                                    <i class="ri-building-4-line"></i>--}}
                                {{--                                    <a href="{{route('achievements-detail',$award->slug)}}"> {{$award->department_name}}</a>--}}
                                {{--                                </li>--}}
                                {{--                                <li>--}}
                            ...
                            <div class="sidebar-widget departments">
                                ...
                                <ul>
                                    @foreach($achievements as $a)
                                        {{--                                    {{dd($e)}}--}}
                                        <li>
                                            <a href="{{route('achievements-detail',$a->slug)}}">
                                                {{$a->name}}
                                                <i class="ri-arrow-right-s-line"></i>
                                            </a>
                                        </li>
                                ...
                                @if(count($achievements) >= 8)
                                    <div class="text-center pb-4">
                                        <a href="{{route('achievements')}}">See More</a>
