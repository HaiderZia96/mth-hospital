        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                    ...
                    @can('manager_user-management_contact-activity-log-trash')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#indextable').DataTable({
                ...
                ajax: {
                    "type": "GET",
                    "url": "{{route('manager.get.contact-us')}}",
                },
                columns: [
                ...
                columnDefs: [
...

                    {
                        ...
                        orderable: false,
                        render: function (data, type, row, meta) {
                            let URL = "{{ route('manager.contact-us.show', ':id') }}";
                            URL = URL.replace(':id', row.id);

                            let ACTIVITY = "{{ route('manager.get.contact-us-activity', ':id') }}";
                            ACTIVITY = ACTIVITY.replace(':id', row.id);

                            return '<div class="d-flex">' +

                                @can('manager_user-management_contact-show')
                                    '<a class="me-1 ms-2" href="' + URL + '"><span class="badge bg-success text-dark">Show</span>' +
                                @endcan
                                    @can('manager_user-management_contact-delete')
                                ...
                                @endcan
                                    @can('manager_user-management_contact-activity-log')
