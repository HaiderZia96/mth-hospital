    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#indextable').DataTable({
                ...
                ajax: {
                    "type": "GET",
                    "url": "{{route('manager.get.achievement')}}",
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            let URL = "{{ route('manager.achievement.show', ':id') }}";
                            URL = URL.replace(':id', row.id);

                            let ACTIVITY = "{{ route('manager.get.achievement-activity', ':id') }}";
                            ACTIVITY = ACTIVITY.replace(':id', row.id);


                            return '<div class="d-flex">' +
                                @can('manager_achievement_award-show')
                                    '<a class="me-1 ms-2" href="' + URL + '"><span class="badge bg-success text-dark">Show</span>' +
                                @endcan
                                    @can('manager_achievement_award-edit')
                                    '<a class="me-1" href="' + URL + '/edit"><span class="badge bg-info text-dark">Edit</span></a>' +
                                @endcan
                                    @can('manager_achievement_award-delete')
                                ...
                                @endcan
                                    @can('manager_achievement_award-activity-log')
