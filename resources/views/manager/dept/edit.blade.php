                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="image-edit mb-3">
                                    ...
                                    <input type="file" accept=".png, .svg" name="icon_url"
                            ...
                            <div class="col-12 col-md-6" id="banner_input">
                                <div class="mb-3">
                                    <div class="image-edit custom-file-button">
                                        ...
                                        <p><small>The previous uploaded image is already selected in case of changing
                            ...
                            <div class="col-12 col-md-6" id="cover-image">
                                <div class="mb-3">
                                    <div class="image-edit custom-file-button">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" id="department-description" name="description"
                                              class="form-control rounded-0">{!! $data->description !!}</textarea>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0 m-0">
                    <div class="img-container">
                        <div class="row pe-4">
                            <div class="col-md-12">
                                <img class="cropper-image" id="previewDepartmentBanner" src="" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("body").on("click", "#coverImageButton", function () {
                ...
                canvas.toBlob(function (blob) {
                    // Crop & Convert it to image
                    const main_div = document.getElementById("cover-image")
                    var x = document.createElement("INPUT");
                    x.setAttribute("type", "file");
