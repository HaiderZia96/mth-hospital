                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control rounded-0" name="e_date"
                                           value="{{old('e_date')}}" id="event_date">
                                    @error('e_date')
                                    <strong class="text-danger">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-md-6" id="thumbnail_input">
                                <div class="image-edit custom-file-button mb-3">
                                    <label class="form-label" for="image-cropper">Thumbnail *</label>
                            ...
                            <div class="col-12 col-md-6" id="banner_input">
                                <div class="mb-3">
                                    <div class="image-edit custom-file-button">
                                        <label class="form-label" for="banner-cropper">Banner *</label>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-0 m-0">
                            <div class="img-container">
                                <div class="row pe-4">
                                    <div class="col-md-12">
                                        <img class="cropper-image" id="previewImage" src="" alt="Thumbnail">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer p-2 m-0">
                            <button type="button" class="btn bg-secondary text-white btn-sm crop" id="cropImage">Crop
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-0 m-0">
                            <div class="img-container">
                                <div class="row pe-4">
                                    <div class="col-md-12">
                                        <img class="cropper-image" id="previewBanner" src="" alt="Department Banner">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn  btn-sm bg-secondary  text-white crop" id="cropBanner">Crop
                            </button>
                        </div>
                    </div>
                </div>
