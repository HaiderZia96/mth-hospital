                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                           name="name"
                                           id="name" placeholder="Name" value="{{(!empty($data->name) && isset($data->name)) ? $data->name : old('name')}}" disabled>
                                    @error('name')
                            ...
                            <div class="col-6" id="image_input">
                                <div class="image-edit custom-file-button mb-3">
                                    ...
                                    <input type="file" id="image-cropper" accept=".png, .jpg, .jpeg" name="image_url"
                                           class="form-control wizard-required image-cropper @error('image_url') is-invalid @enderror" disabled>
                                    @error('image_url')
                                    <strong class="text-danger">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('venue') is-invalid @enderror"
                                           name="venue"
                                           id="venue" placeholder="Venue." value="{{(!empty($data->venue) && isset($data->venue)) ? $data->venue : old('venue')}}" disabled>
                                    @error('venue')
                                    <strong class="text-danger">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <select class="select2-options-department-id form-control @error('department_id') is-invalid @enderror" name="department_id" disabled></select>
                                    @error('department_id')
                                    <strong class="text-danger">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('conference_date') is-invalid @enderror" name="conference_date"
                                           id="conference_date" placeholder="Year" value="{{(!empty($data->conference_date) && isset($data->conference_date)) ? $data->conference_date : old('conference_date')}}" disabled>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('conference_workshop') is-invalid @enderror"
                                           ...
                                           id="conference_workshop" placeholder="Conference Workshop" value="{{(!empty($data->conference_workshop) && isset($data->conference_workshop)) ? $data->conference_workshop : old('conference_workshop')}}" disabled>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" id="description" value="{{ old('description') }}" name="description" class="form-control  rounded-0" disabled>{!! $data->description !!}</textarea>
                                </div></div>
