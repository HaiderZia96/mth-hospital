    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#indextable').DataTable({
                ...
                ajax: {
                    "type": "GET",
                    "url": "{{route('manager.get.team-member')}}",
                },
                columns: [
                    {data: 'id'},
                    {data: 'name'},
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            return '<div class="d-flex">' +
                                ...
                                @endcan
                                    @can('manager_team_member-activity-log')
