                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('phone_no') is-invalid @enderror"
                                           name="phone_no"
                                           id="phone_no" placeholder="Phone No." value="{{old('phone_no')}}">
                                    @error('phone_no')
                                    <strong class="text-danger">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-md-6" id="image_input">
                                <div class="image-edit custom-file-button mb-3">
                                    <label class="form-label" for="image-cropper">Profile Image *</label>
                            ...
                            <div class="col-12 col-md-12 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="education" id="education" cols="30" rows="3"
                                              class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="membership" id="membership" cols="30" rows="3"
                                              class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="speciality" id="speciality" cols="30" rows="2"
                                              class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
